...
<nav class="navbar navbar-expand-lg navbar-light ">
    <a style="font-weight: bold; font-size:34px; color: #d21717;" class="navbar-brand" href="#">
    <strong>
    <?php
        ...
        ";
            ...
            while ($row = mysqli_fetch_assoc($result))  {
                echo '<option value="' . $row['id_destinataire'] . '"><strong><em>' . $row['nom_destinataire'] ." ". $row['prenom_destinataire'] . '</em></strong></option>';
            }
